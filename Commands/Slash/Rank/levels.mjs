...
export default {
    ...
    data: new SlashCommandBuilder()
        .setName('levels')
        .setDescription('Quản lí levels')
        .setDMPermission(false)
        .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
        .addSubcommand(sub => sub.setName("add").setDescription("Tặng leverls")
            .addNumberOption(option => option
                .setMinValue(1)
                .setMaxValue(100)
                .setName("level")
                .setDescription("Enter để add")
                .setRequired(true))
            .addUserOption(option => option
                .setName("user")
                .setDescription("Select User!")
                .setRequired(true)))
        .addSubcommand(sub => sub.setName("remove").setDescription("Trừ levels khỏi thành viên")
            .addNumberOption(option => option
                .setMaxValue(1)
                .setMaxValue(100)
                .setName("level")
                .setDescription("Số levels muốn trừ")
                .setRequired(true))
            .addUserOption(option => option
                .setName("user")
                .setDescription("Select User!")
                .setRequired(true)))
        .addSubcommand(sub => sub.setName("set").setDescription("Thay đổi giá trị levels của thành viên một cách tùy ý")
            .addUserOption(option => option
                .setName("user")
            ...
            .addNumberOption(option => option
                ...
                .setMaxValue(250)
                .setName("level")
                .setDescription("Levels muốn set")
                .setRequired(true)))
