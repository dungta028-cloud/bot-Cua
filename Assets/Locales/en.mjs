export default {
  common: {
    ...
    loading: "!{l} Loading...",
    no_user_perm: "!{i} Mày đéo có quyền dùng lệnh này",
    no_bot_perm: "!{i} Tao chưa có quyền để dùng lệnh này nhé tuất",
    cooldown: "!{i} Chậm lại tí đê tuất mày còn phải đợi {{time}} nữa cơ",
    no_args: "!{i} Please Provide Following Arguments",
    timeout: "!{skull} **Hết cụ thời gian nhẹ nhàng r nhóc!** Dùng lại lệnh để t nhẹ nhàng lại với mày!!!!",
    pageContent: "__***Thưa ngài dưới đây là toàn bộ code tôi có ạ***__",
    enabled: "Enabled",
